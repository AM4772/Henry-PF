    ...
    useEffect(() => {
        const asyncGetSeriesPayments = async () => {
            const response = await axios.get(
                'https://pf-bookstore-main.onrender.com/stats'
            );
            let both = {};
            for (let i = 0; i < response.data.payments.length; i++) {
                both[response.data.payments[i].createdAt.substring(0, 10)] =
                    ...
                    (both[response.data.payments[i].createdAt.substring(0, 10)]
                        ? both[
                              response.data.payments[i].createdAt.substring(
                                  0,
                                  10
                              )
                          ]
    ...
    useEffect(() => {
        const asyncGetSeriesUsers = async () => {
            ...
            for (let i = 0; i < response.data.users.createdDate.length; i++) {
                both[
                    response.data.users.createdDate[i].createdAt.substring(
                        0,
                        10
                    )
                ] =
                    ...
                    (both[
                        ...
                        ? both[
                              response.data.users.createdDate[
                                  i
